  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <p>Gradient abie es una plataforma líder en análisis de negocios y comercio electrónico. Ayudamos a las empresas a crecer y prosperar en la era digital.</p>
      </div>
      <div class="col-md-3">
        ...
        <ul>
          ...
          <li><a href="#">Formularios y Tablas</a></li>
          <li><a href="#">Gráficos y Mapas</a></li>
        </ul>
      </div>
      <div class="col-md-3">
        <h5>Contacto</h5>
        <p>barrio manga calle 34 #23-34 </p>
        <p>Email: info@gradientabie.com</p>
      </div>
    </div>
  </div>
</footer>
